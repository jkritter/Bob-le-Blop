...
public class FenetreChoixDesAttributs extends JFrame implements ActionListener {
    ...
    public FenetreChoixDesAttributs (){
		...
		regles.setText("<html> Bienvenue !  <br> Vous allez maintenant choisir les "
				+ "caract�ristiques de votre blob, le but etant que la population soit la plus grande possible � la fin de la partie. "
				+ "Vous avez 300 points au total � r�partir dans chacune des caracteristiques, sans d�passer 120points par caracteristiques."
